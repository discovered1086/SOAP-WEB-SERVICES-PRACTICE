 ...
 * 2019-01-14T20:13:37.834-06:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "SOAPFaultWebService",
                  wsdlLocation = "file:/Volumes/Work/SPRING-ECLIPSE-PROJECT/SOAPFaultWebService/src/main/resources/SOAPFaultWebService.wsdl",
...
public class SOAPFaultWebService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Volumes/Work/SPRING-ECLIPSE-PROJECT/SOAPFaultWebService/src/main/resources/SOAPFaultWebService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SOAPFaultWebService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/Volumes/Work/SPRING-ECLIPSE-PROJECT/SOAPFaultWebService/src/main/resources/SOAPFaultWebService.wsdl");
        }
        WSDL_LOCATION = url;
    }
