 ...
 * 2019-01-30T12:40:48.927-06:00
 * Generated source version: 3.0.2
 * 
 */
@WebServiceClient(name = "StudentInfoServices", 
                  wsdlLocation = "file:/Volumes/Work/LOCAL-GIT-REPOSITORY/SOAP-WEB-SERVICES-PRACTICE/StudentinfoServiceClient/src/main/resources/StudentsInfo.wsdl",
...
public class StudentInfoServices extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Volumes/Work/LOCAL-GIT-REPOSITORY/SOAP-WEB-SERVICES-PRACTICE/StudentinfoServiceClient/src/main/resources/StudentsInfo.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(StudentInfoServices.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Volumes/Work/LOCAL-GIT-REPOSITORY/SOAP-WEB-SERVICES-PRACTICE/StudentinfoServiceClient/src/main/resources/StudentsInfo.wsdl");
        }
        WSDL_LOCATION = url;
    }
